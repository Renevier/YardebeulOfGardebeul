...
void AnimationComponent::AddAnimation(const string _key,float _animation_timer,
	int _start_frames_x, int _start_frames_y, int _frames_x, int _frames_y, int _width, int _height)
{
	this->animations[_key] = new Animation(this->sprite, this->textureSheet,
		_animation_timer,
